...
export function Hero(){
    return(
        <section className="bg-white">
            <div className="container mx-auto pb-4 px-4 pt-20 sm:pb-0 sm:px-6 lg:px-8">
            ...
            <main className="flex items-center justify-center">
                <article className="flex-2 max-w-3xl space-y-8 flex flex-col justify-center">
                    ...
                    <Button className="bg-emerald-500 hover:bg-emerald-700 cursor-pointer w-fit px-6 font-semibold">
